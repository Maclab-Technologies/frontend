...
const designCategories = [
  ...
  { name: "ID Card", price: 3000 },
  { name: "Banner Design", price: 8000 },
];
...
// Keep statesAndLGAs object as is from your original code
...
export default function HireDesigner() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Store in localStorage as per the original code
      const dataToSave = {
        ...formData,
        status: "pending",
      ...
      // Success! Redirect to success page or My Designs
      alert("Design request submitted successfully! You can track your request in My Designs.");
      
      // In a real app, you'd redirect to a success page or My Designs page
