...
export default function ProductsPage() {
  ...
  return (
    <div className="bg-black w-full min-h-screen ">
      <div className="w-[90%] h-60 bg-yellow-500 text-black text-center mx-auto flex items-center justify-center shadow-md">
      ...
      <div className="grid flex-wrap  md:grid-cols-3 gap-3 mt-2">
        {filteredProducts.map((product) => (
          <div key={product.id} className="bg-white rounded-lg shadow-lg flex gap-3 items-center  m-2">
            <Image
