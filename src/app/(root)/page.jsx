  ...
  return (
    <div className="bg-black text-white min-h-screen">
      ...
      <section className="flex flex-col md:flex-row items-center justify-between py-16 md:py-24 md:min-h-screen">
        ...
        >
          {/* Replace brandguy with your actual image */}
          <div className="max-w-md w-full h-64 bg-gray-700 rounded-lg shadow-xl flex items-center justify-center">
          ...
          {isLoading ? (
            ...
            <div className="bg-gray-800/50 text-center p-8 border border-red-500 rounded-lg max-w-lg mx-auto">
              ...
              <button
                onClick={() => {
                  ...
                  console.log("Retry fetching categories");
                }}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
              {categories.map((category, index) => (
                ...
                >
                  {/* Popular Badge - showing for first 3 items */}
                  {index < 5 && (
