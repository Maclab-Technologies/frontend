...
const ClientNavLayout = () => {
  ...
  return (
    <header className="w-full">
              ...
              {!isLoggedIn ? (
                ...
                <>
                  ...
                  >
                    ...
                    {cartCount > 0 && (
                      <span className="absolute -top-2 -right-2 bg-red-500 text-white text-xs font-bold w-5 h-5 flex items-center justify-center rounded-full cart-bounce">
                  ...
                  <div className="relative group">
                    ...
                    {/* Dropdown */}
                    <div className="absolute right-0 mt-2 w-64 bg-black/95 navbar-blur rounded-xl shadow-xl border border-yellow-400/20 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform origin-top-right scale-95 group-hover:scale-100 z-50">
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed top-0 right-0 h-full w-80 bg-black/95 navbar-blur shadow-2xl z-50 transform transition-transform duration-300 md:hidden border-l border-yellow-400/20 ${
